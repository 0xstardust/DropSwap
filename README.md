...
In this example, you can create your own NFT Drop minting with swapping functionalit by simply customising the template with your branding, and plugging in your NFT Drop contract address. 
